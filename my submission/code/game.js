...
var actorChars = {
  ...
  //"g": Goo, ///A block that prevents movement and pulls you down.  used during the 'instawin' mini courses to plan a freefall
};
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  /// goo slows your fall, you're at the mercy of gravity, gives time to plan your falls for the instawin token
    if (obstacle == 'goo') {
    level.playerTouched(obstacle);
    this.speed.y = 3;
      this.pos = newPos;
